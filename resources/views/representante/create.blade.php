            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="admin"  name="admin" action="{{ route('store.repre') }}" >
                        ...
                        <div class="row mb-3">
                            <label for="coordi" class="col-md-4 col-form-label text-md-end">{{ __('Coordinador') }}</label>

                            <div class="col-md-6">
                                <select id="coordi" name="coordi" value="{{ old('coordi') }}"class="form-control select2" style="width: 100%;" required>
                                    <option selected="selected" value="Mujer">Eric Vasquez Gomez</option>
                                    <option value="Hombre">Elizabeth Hernandez </option>
                                  </select>
                                @error('coordi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
