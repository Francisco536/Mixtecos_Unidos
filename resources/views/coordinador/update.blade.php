                ...
                <div class="card-body">
                    <form method="POST" id="admin"  name="admin" action="{{ route('update.coordi', $coordi->id) }}" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $coordi->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="ap_paterno" type="text" class="form-control @error('ap_paterno') is-invalid @enderror" name="ap_paterno" value="{{ $coordi->ap_paterno }}" required autocomplete="ap_paterno" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="ap_materno" type="text" class="form-control @error('ap_materno') is-invalid @enderror" name="ap_materno" value="{{ $coordi->ap_materno }}" required autocomplete="ap_materno" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control"  name="telefono" value="{{ $coordi->telefono }}" required autocomplete="telefono" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $coordi->correo }}" required autocomplete="email">
